...
declare namespace Pxt_Sentry {

    /**
     * Initialize Sentry.
     */
    //% blockId=begin shim=Pxt_Sentry::begin
    function begin(id: SentryId, port: sentry_mode_e): void;

    /**
     * Reset Sentry.
     */
    //% blockId=SensorSetDefault shim=Pxt_Sentry::setDefault
    function setDefault(id: SentryId): void;

    /**
     * Sentry vision begin.
     */
    //% blockId=visionBegin shim=Pxt_Sentry::visionBegin
     ...
     */
    //% blockId=ledSetColor shim=Pxt_Sentry::ledSetColor
     ...
     */
    //% blockId=cameraSetZoom shim=Pxt_Sentry::cameraSetZoom
     ...
     */
    //% blockId=cameraSetAwb shim=Pxt_Sentry::cameraSetAwb
     ...
     * @param on FPS type.
     */
    //% blockId=cameraSetFPS shim=Pxt_Sentry::cameraSetFPS
     ...
     */
    //% blockId=getValue shim=Pxt_Sentry::getValue
